...
class WanRunner(DefaultRunner):
    ...
    def get_latent_shape_with_target_hw(self):
        target_height = self.input_info.target_shape[0] if len(self.input_info.target_shape) == 2 else self.config["target_height"]
        target_width = self.input_info.target_shape[1] if len(self.input_info.target_shape) == 2 else self.config["target_width"]
